...
```bash
$ bash -c "$(curl -fsSL raw.github.com/evdhoudt/dotfiles/master/bin/dotfiles)"
```
...
GIT_AUTHOR_NAME="Edwin van den Houdt"
GIT_AUTHOR_EMAIL="edwin@example.com"
